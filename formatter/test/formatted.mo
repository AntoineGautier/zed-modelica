...
model AirToWater "Air-to-water heat pump plant" extends Buildings.Templates.Plants.HeatPumps.Interfaces.PartialHeatPumpPlant(
...
Fluid.Sources.Boundary_pT bouHeaWat(
  ...
  annotation(Line(points={{-60,80},{-60,80},{-40,80}}, color={0,0,0},
    thickness=0.5,
  ...
  annotation(Line(points={{40,80},{50,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat));
  ...
  annotation(Line(points={{-60,80},{-60,80},{-20,80}}, color={0,0,0},
    thickness=0.5,
    visible=have_chiWat and
    typArrPumPri == Buildings.Templates.Components.Types.PumpArrangement.Dedicated));
  connect(supChiWatPri.port_b, VChiWatPri_flow.port_a)
  annotation(Line(points={{0,80},{20,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat and
    typArrPumPri == Buildings.Templates.Components.Types.PumpArrangement.Dedicated));
  connect(valIso.ports_bChiHeaWatHp, pumPri.ports_aChiHeaWat)
  annotation(Line(points={{-250,-50},{-250,-50}}, color={0,127,255}));
  ...
  annotation(Line(points={{270,80},{288,80}}, color={0,0,0},
    visible=have_chiWat and
    typPumChiWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.Centralized,
    thickness=0.5));
  connect(port_bChiWat, dpChiWatLoc.port_a)
  annotation(Line(points={{600,80},{560.5,80},{560.5,50}}, color={0,127,255},
    visible=false));
  connect(dpChiWatLoc.port_b, port_aChiWat)
  annotation(Line(points={{560.5,30},{560.5,0},{600,0}}, color={0,127,255},
    visible=false));
  connect(port_bHeaWat, dpHeaWatLoc.port_a)
  annotation(Line(points={{600,-280},{560.5,-280},{560.5,-310}},
    color={0,127,255}, visible=false));
  ...
  annotation(Line(points={{40,-280},{50,-280}}, color={0,0,0}, thickness=0.5));
  ...
  annotation(Line(points={{0,-280},{20,-280}}, color={0,0,0}, thickness=0.5,
    visible=have_heaWat and
    typArrPumPri == Buildings.Templates.Components.Types.PumpArrangement.Dedicated));
  connect(supHeaWatSec.port_b, VHeaWatSec_flow.port_a)
  annotation(Line(points={{270,-280},{290,-280}}, color={0,0,0}, thickness=0.5,
    visible=have_heaWat and
    typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.Centralized));
  connect(outPumHeaWatSec.port_b, VHeaWatSec_flow.port_a)
  annotation(Line(points={{290,-280},{290,-280}}, color={0,0,0}, thickness=0.5));
  connect(valIso.port_bHeaWat, inlPumHeaWatPri.port_a)
  annotation(Line(points={{-540,20},{-540,-280},{-40,-280}}, color={0,0,0},
    thickness=0.5,
    visible=have_heaWat and
    typArrPumPri == Buildings.Templates.Components.Types.PumpArrangement.Headered));
  connect(VHeaWatSec_flow.port_b, port_bHeaWat)
  annotation(Line(points={{310,-280},{600,-280}}, color={0,0,0}, thickness=0.5));
  connect(valIso.port_bHeaWat, supHeaWatPri.port_a)
  annotation(Line(points={{-540,20},{-540,-280},{-20,-280}}, color={0,0,0},
    thickness=0.5,
    visible=have_heaWat and
    typArrPumPri == Buildings.Templates.Components.Types.PumpArrangement.Dedicated));
  connect(junChiWatBypSup.port_2, TChiWatSecSup.port_a)
  annotation(Line(points={{190,80},{210,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat));
  connect(TChiWatSecSup.port_b, inlPumChiWatSec.port_a)
  annotation(Line(points={{230,80},{230,80}}, color={0,0,0}, thickness=0.5));
  connect(junChiWatBypRet.port_1, TChiWatSecRet.port_b)
  annotation(Line(points={{190,0},{310,0}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5, visible=have_chiWat));
  connect(junHeaWatBypSup.port_2, THeaWatSecSup.port_a)
  annotation(Line(points={{190,-280},{210,-280}}, color={0,0,0}, thickness=0.5));
  connect(THeaWatSecSup.port_b, inlPumHeaWatSec.port_a)
  annotation(Line(points={{230,-280},{230,-280}}, color={0,0,0}, thickness=0.5));
  connect(THeaWatSecSup.port_b, supHeaWatSec.port_a)
  annotation(Line(points={{230,-280},{250,-280}}, color={0,0,0}, thickness=0.5,
    visible=have_heaWat and
    typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.Centralized));
  connect(TChiWatSecSup.port_b, supChiWatSec.port_a)
  annotation(Line(points={{230,80},{250,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat and
    typPumChiWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.Centralized));
  connect(junHeaWatBypRet.port_1, THeaWatSecRet.port_b)
  annotation(Line(points={{190,-360},{310,-360}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash));
  connect(outPumChiWatSec.port_b, VChiWatSec_flow.port_a)
  annotation(Line(points={{290,80},{288,80}}, color={0,0,0}, thickness=1));
  connect(TChiWatPriRet.port_b, valIso.port_aChiWat)
  annotation(Line(points={{50,0},{0,0},{0,40},{-60,40}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5, visible=have_chiWat));
  connect(junHeaWatHrcEnt.port_2, junHeaWatHrcLvg.port_1)
  annotation(Line(points={{490,-360},{390,-360}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash));
  connect(junHeaWatHrcLvg.port_2, THeaWatSecRet.port_a)
  annotation(Line(points={{370,-360},{330,-360}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash));
  connect(junHeaWatHrcEnt.port_3, hrc.port_a1)
  annotation(Line(points={{500,-350},{500,-180},{380,-180},{380,-160}},
    color={0,0,0}, thickness=0.5, pattern=LinePattern.Dash, visible=have_hrc));
  connect(hrc.port_b1, junHeaWatHrcLvg.port_3)
  annotation(Line(points={{500,-160},{440,-160},{440,-200},{380,-200},{380,-350}},
    color={0,0,0}, thickness=0.5, visible=have_hrc));
  connect(junChiWatHrcEnt.port_3, hrc.port_a2)
  annotation(Line(points={{500,-10},{500,-88}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash, visible=have_hrc));
  connect(junChiWatHrcEnt.port_2, junChiWatHrcLvg.port_1)
  annotation(Line(points={{490,0},{390,0}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash, visible=have_chiWat));
  connect(junChiWatHrcLvg.port_2, TChiWatSecRet.port_a)
  annotation(Line(points={{370,0},{330,0}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash, visible=have_chiWat));
  connect(hrc.port_b2, junChiWatHrcLvg.port_3)
  annotation(Line(points={{380,-88},{380,-10}}, color={0,0,0}, thickness=0.5,
    visible=have_hrc));
  connect(port_aChiWat, TChiWatRetUpsHrc.port_a)
  annotation(Line(points={{600,0},{550,0}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5, visible=have_chiWat));
  connect(TChiWatRetUpsHrc.port_b, junChiWatHrcEnt.port_1)
  annotation(Line(points={{530,0},{510,0}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5));
  connect(port_aHeaWat, THeaWatRetUpsHrc.port_a)
  annotation(Line(points={{600,-360},{550,-360}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5));
  connect(THeaWatRetUpsHrc.port_b, junHeaWatHrcEnt.port_1)
  annotation(Line(points={{530,-360},{510,-360}}, color={0,0,0},
    pattern=LinePattern.Dash, thickness=0.5));
  connect(junChiWatBypSup.port_3, valChiWatMinByp.port_a)
  annotation(Line(points={{180,70},{180,50}}, color={0,0,0}, thickness=0.5));
  connect(valChiWatMinByp.port_b, junChiWatBypRet.port_3)
  annotation(Line(points={{180,30},{180,10}}, color={0,0,0}, thickness=0.5));
  connect(junHeaWatBypSup.port_3, valHeaWatMinByp.port_a)
  annotation(Line(points={{180,-290},{180,-310}}, color={0,0,0}, thickness=0.5));
  connect(valHeaWatMinByp.port_b, junHeaWatBypRet.port_3)
  annotation(Line(points={{180,-330},{180,-350}}, color={0,0,0}, thickness=0.5));
  connect(VChiWatSec_flow.port_b, port_bChiWat)
  annotation(Line(points={{308,80},{600,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat));
  connect(TChiWatPriSup.port_b, tanChiWatSup.port_a)
  annotation(Line(points={{70,80},{120,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat));
  connect(tanChiWatSup.port_b, junChiWatBypSup.port_1)
  annotation(Line(points={{140,80},{170,80}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat));
  connect(junChiWatBypRet.port_2, tanChiWatRet.port_a)
  annotation(Line(points={{170,0},{140,0}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat, pattern=LinePattern.Dash));
  connect(tanChiWatRet.port_b, TChiWatPriRet.port_a)
  annotation(Line(points={{120,0},{70,0}}, color={0,0,0}, thickness=0.5,
    visible=have_chiWat, pattern=LinePattern.Dash));
  connect(THeaWatPriSup.port_b, tanHeaWatSup.port_a)
  annotation(Line(points={{70,-280},{120,-280}}, color={0,0,0}, thickness=0.5));
  connect(tanHeaWatSup.port_b, junHeaWatBypSup.port_1)
  annotation(Line(points={{140,-280},{170,-280}}, color={0,0,0}, thickness=0.5));
  connect(junHeaWatBypRet.port_2, tanHeaWatRet.port_a)
  annotation(Line(points={{170,-360},{140,-360}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash));
  connect(tanHeaWatRet.port_b, THeaWatPriRet.port_a)
  annotation(Line(points={{120,-360},{70,-360}}, color={0,0,0}, thickness=0.5,
    pattern=LinePattern.Dash));
  ...
  annotation(Line(points={{50,-360},{-580,-360},{-580,60},{-540,60}},
    color={0,0,0}, thickness=0.5, pattern=LinePattern.Dash)); annotation(defaultComponentName="pla",
  Documentation(info="<html>
<h4>Description</h4>
<p>
This template represents an air-to-water heat
pump plant with closed-loop controls. While the heat pump plant configuration
can be changed through parameters, the image below shows a typical configuration
with two reversible air-to-water heat pumps, a primary-secondary distribution
system and a sidestream heat recovery chiller. For a detailed schematic of the
actual plant configuration, refer to the diagram view of the plant component. In
Dymola, for example, you can access this by right-clicking the component <code>
pla</code> in the model
...
<p>
Currently, only identical heat pumps are supported. Although the
template can accommodate any number of identical heat pumps, the graphical
feedback for system configuration via the diagram layer is only accurate for up
to 6 devices.
</p>
<p>
The supported plant configurations are enumerated in the
table below. The first option displayed in bold characters corresponds to the
default configuration.<br/>
</p>
<table summary=\"summary\" border=\"1\">
<tr>
<th>Configuration parameter</th><th>Options</th><th>Notes</th></tr>
<tr><td>
Function</td>
<td>
...
<td>
The
plant always provides heating hot water.<br/>
Setting the parameter <code>
have_chiWat</code> to true (default setting) allows modeling a plant that
provides both heating hot water and chilled water.
</td>
</tr>
<tr><td>Heat
recovery</td><td><b>Without sidestream heat recovery chiller</b><br/>With
sidestream heat recovery chiller
</td>
<td>
This option is only available for
heating and cooling plants.When selected, the template includes a chiller and
its associated dedicated primary CHW and CW pumps. The chiller is considered
connected in a sidestream configuration to both the CHW return and the HW
return.
</td>
</tr>
...
<td>
<b>Constant
primary-variable secondary centralized</b><br/>
...
Most AWHPs on the market use a reverse
cycle for defrosting. This requires maximum primary flow during defrost cycles.
Consequently, variable primary plants commonly adopt a high minimum flow
setpoint, typically close to the design flow rate, effectively operating akin to
constant primary plants but with variable speed pumps controlling the loop
differential pressure. While the flow rate directed towards the loads varies,
the bypass valve control loop ensures a constant primary flow for a given number
of staged units.<br/>
\"Centralized secondary pumps\" refers to configurations
with a single group of secondary pumps that is typically integrated into the
plant.<br/>
...
<tr><td>Type
of primary pump arrangement</td>
<td>
<b>Dedicated</b><br/>
Headered
</td>
...
<tr><td>Separate
dedicated primary CHW pumps</td>
<td>
<b>False</b><br/>
True
</td>
<td>This
option is only available for heating and cooling plants with dedicated primary
pumps. If this option is not selected (default setting), each AWHP uses a common
dedicated primary pump for HW and CHW – this pump is then denoted as the primary
HW pump. Otherwise, each AWHP relies on a separate dedicated HW pump and a
separate dedicated CHW pump.
</td>
</tr>
...
<td>
For constant
primary-variable secondary distributions, the variable speed primary pumps are
commanded at fixed speeds, determined during the Testing, Adjusting and
Balancing phase to provide design AWHP flow in heating and cooling modes. The
same intent is achieved with constant speed primary pumps through the use of
balancing valves.
</td>
</tr>
...
<td>See the note above on primary
HW pumps.</td>
</tr>
<tr><td>HW buffer tank</td>
<td>
<b>HW buffer tank in the
primary supply</b><br/>
HW buffer tank in the primary return<br/>
No HW buffer
tank
</td>
<td>By default, the HW buffer tank is considered integrated into the
primary supply to mitigate the impact of defrost cycles on the temperature of
the HW supplied to the loads. This assumes that the buffer tank is well-mixed.
</br>
The default sizing of the tank corresponds to <i>4</i>&nbsp;min of the
design primary flow rate. This is based on manufacturer recommendations, which
account for the fact that defrost cycles can take <i>3</i> to <i>5</i>&nbsp;min
to complete.
</td>
</tr>
<tr><td>CHW buffer tank</td>
<td>
<b>CHW buffer tank in
the primary return</b><br/>
CHW buffer tank in the primary supply<br/>
No CHW
buffer tank
</td>
<td>By default, the CHW buffer tank is considered integrated
into the primary return to mitigate the impact of rapid load variations on the
plant controls. This assumes that the buffer tank is well-mixed.</br>
The
default sizing of the tank corresponds to <i>2</i>&nbsp;min of the design
primary flow rate, based on manufacturer recommendations.
</td>
</tr>
<tr><td>
Controller</td>
<td>
<b>Closed-loop controls with supply temperature and
differential pressure reset</b><br/>
</td>
<td>
Most parts of the sequence of
operation are similar to that described in ASHRAE, 2021 for chiller plants.<br/>
...
<p>
The control sequence implemented in
this template requires the external input points specified in the documentation
of the controller
...
<p>
The pressure drops of the heat pump CHW and HW
heat exchangers are calculated within the isolation valve component <code>valIso
</code> based on lumped flow coefficients for the sake of computational
efficiency.
</p>
<p>
The template uses a heat pump model that interpolates
capacity and power from manufacturer data along the CHW/HW temperature, the
outdoor air temperature and the part load ratio. The heat pump performance data
are provided via the subrecords
<code>dat.hp.perHeaHp</code> and <code>
dat.hp.perCooHp</code> for the heating mode and the cooling mode, respectively.
For the required format of the performance data files, please refer to the
documentation of the block
...
Refactored with
load-dependent 2D table data heat pump model.<br/>
This is for
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/4152\">#4152</a>.
</li>
<li>
May 31, 2024, by Antoine Gautier:<br/>
Added sidestream heat recovery
chiller, primary-only pumping, buffer tanks, failsafe staging conditions and
internal computation of pump speed or balancing valve ∆p to meet design flow.
<br/>
This is for
...
First implementation.
  ...
  lineColor={0,0,0}, visible=have_chiWat and not ctl.have_senDpChiWatRemWir),
  Polygon(points={{560,36},{560,0},{561,0},{561,36}}, lineColor={0,0,0},
  visible=have_chiWat and not ctl.have_senDpChiWatRemWir),
  Polygon(points={{560,-324},{560,-360},{561,-360},{561,-324}},
  lineColor={0,0,0}, visible=have_heaWat and not ctl.have_senDpHeaWatRemWir),
  Polygon(points={{560,-280},{560,-316},{561,-316},{561,-280}},
  lineColor={0,0,0}, visible=have_heaWat and not ctl.have_senDpHeaWatRemWir)})) AirToWater
